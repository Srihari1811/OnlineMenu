...
app.post('/submitOrder', async (req, res) => {
  const { name, mobile, amount, products, tableNumber } = req.body; // Include tableNumber in the request body
...
app.put('/addproducts/:id', async (req, res) => {
  try {
    ...
    const { available, name, price } = req.body;
