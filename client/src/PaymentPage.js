    ...
    <div className="container mt-5 payment-container">
      ...
      {isSubmitted ? (
        <div className="order-summary-container text-center">
          <h5 className="mb-4" style={{color:"red",fontWeight:"bold",fontSize:"1.6rem"}}>Order Summary</h5>
          ...
          <h5 className="mt-4"style={{color:"red",fontWeight:"bold",fontSize:"1.6rem"}}>Cart Items</h5>
        ...
        <form onSubmit={handleSubmit} className="text-center">
          ...
          <div className="mb-3">
            <label htmlFor="tableNumber" className="form-label">Table Number</label> {/* New input for table number */}
            <input
              type="text"
              id="tableNumber"
              className="form-control text-center"
